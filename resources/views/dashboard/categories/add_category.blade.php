                ...
                <div class="row inputs">
                    <div class="col-12 col-md-6 mb-4">
                        <div class="input-field">
                            ...
                            <input type="text" placeholder="Product Name" name="name" value="{{old('name')}}" class="@error('name') is-invalid @enderror"/>
                            @error('name')
                    ...
                    <div class="col-12 col-md-6 mb-4">
                        <div class="input-field">
                            ...
                            <input type="text" name="icon" placeholder="img name with extension" value="{{old('icon')}}" class="@error('icon') is-invalid @enderror"/>
                            @error('icon')
                            <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
